...
class StyledImage extends StatelessWidget {
  const StyledImage(this.name, {super.key, this.width = 100, this.height = 100, this.bgColor, this.borderWidth = 0, this.borderColor, this.trBackground = false, this.isSVG = true, this.radius = 50});
  final String name;
  final double width;
  final double height;
